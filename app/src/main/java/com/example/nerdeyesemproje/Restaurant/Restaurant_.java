    ...
    public String toString() {
        return
                "Address: "+getLocation().getAddress()+
                        ...
                        "\n\nAverage Cost For Two: " + averageCostForTwo +" "+getCurrency()+

                        "\n\nAggregate Rating" + getUserRating().getAggregateRating() +
                        ", ("+getUserRating().getRatingText()+")"+"\n\n Votes: "+getUserRating().getVotes();
    }
